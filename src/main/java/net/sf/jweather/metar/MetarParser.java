...
public class MetarParser {
    ...
    public static void main(String[] args) {
        try {
            ...
            for (File file : files) {
                if (file.isFile()) {
                    // Process each file
                    MetarParser.parse(file.getAbsolutePath());
                }
            }
     ...
     *
     * @param metarString The string containing both the date and the report.
     * @return The Metar object describing the report
     */
    public static Metar parseRecord(String metarString) throws MetarParseException {
        ...
        if(metarString.contains("\n")) {
            ...
            String[] dataString = metarString.split(" ");
            return parseReport(dataString[1], metarString);
        }
    }
